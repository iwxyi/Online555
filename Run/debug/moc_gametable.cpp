...
QT_MOC_LITERAL(1, 10, 13), // "signalPressed"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 2), // "id"
QT_MOC_LITERAL(4, 28, 7), // "player1"
QT_MOC_LITERAL(5, 36, 7) // "player2"

    },
    "GameTable\0signalPressed\0\0id\0player1\0"
    "player2"
};
...
void GameTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GameTable *_t = static_cast<GameTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GameTable::*_t)(int , QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameTable::signalPressed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject GameTable::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GameTable.data,
      qt_meta_data_GameTable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GameTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameTable.stringdata0))
        return static_cast<void*>(const_cast< GameTable*>(this));
...
// SIGNAL 0
void GameTable::signalPressed(int _t1, QString _t2, QString _t3)
{
