...
QT_MOC_LITERAL(1, 12, 20), // "signalMovesGridEvent"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 1), // "x"
QT_MOC_LITERAL(4, 36, 1), // "y"
QT_MOC_LITERAL(5, 38, 19), // "signalGameOverEvent"
QT_MOC_LITERAL(6, 58, 3) // "win"

    },
    "BoardWidget\0signalMovesGridEvent\0\0x\0"
    "y\0signalGameOverEvent\0win"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalMovesGridEvent((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->signalGameOverEvent((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (BoardWidget::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoardWidget::signalMovesGridEvent)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (BoardWidget::*_t)(bool , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoardWidget::signalGameOverEvent)) {
                *result = 1;
                return;
            }
        }
...
void *BoardWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Chequer"))
        return static_cast< Chequer*>(const_cast< BoardWidget*>(this));
...
// SIGNAL 0
void BoardWidget::signalMovesGridEvent(int _t1, int _t2)
{
...
// SIGNAL 1
void BoardWidget::signalGameOverEvent(bool _t1, int _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
