...
QT_MOC_LITERAL(6, 51, 12), // "slotRegister"
QT_MOC_LITERAL(7, 64, 9), // "slotLogin"
QT_MOC_LITERAL(8, 74, 14), // "slotSwitchRecv"
QT_MOC_LITERAL(9, 89, 3) // "str"

    },
    "LoginWindow\0signalUserInfo\0\0username\0"
    "integral\0rank\0slotRegister\0slotLogin\0"
    "slotSwitchRecv\0str"
};
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->slotSwitchRecv((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (LoginWindow::*_t)(QString , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginWindow::signalUserInfo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginWindow::signalUserInfo(QString _t1, int _t2, int _t3)
{
